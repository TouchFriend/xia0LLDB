...
def __lldb_init_module(debugger, internal_dict):
    ...
    'command script add -f debugptrace.handle_command debugptrace -h "patch ptrace funtion in lldb"')
    # print('========')
    # print('[debugptrace]: patch ptrace funtion in lldb')
    # print('\tdebugptrace ')
    # print('\tmore usage, try "debugptrace -h"')
...
def generate_option_parser():
    ...
    parser.add_option("-a", "--address",
                    ...
                    default=None,
                    dest='patchAddress',
                    help="patch ptrace funtion in lldb")
